                ...
                <div className="flex items-start mt-4 pt-4 border-t">
                  ...
                  <div>
                    ...
                    <div className="text-sm">
                      {new Date(nextAppointment.date).toLocaleDateString()} alle{" "}
        ...
        <div className="w-full md:w-2/3">
              ...
              <div className="space-y-4">
                ...
                {medicalRecords.length === 0 && (
                  <div className="text-center py-8 text-muted-foreground">
                    Nessun documento medico disponibile per questo paziente.
                  </div>
                )}
              </div>
            </TabsContent>
            ...
            >
              <div className="flex justify-between items-center mb-4">
                ...
                <Button
                  onClick={async () => {
                    try {
                      // Apri il form per inviare un nuovo messaggio WhatsApp
                      const dialog = document.createElement("div");
                      dialog.className =
                        "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50";
                      dialog.innerHTML = `<div id="whatsapp-form-container" class="bg-white rounded-lg p-6 w-full max-w-2xl"></div>`;
                      document.body.appendChild(dialog);

                      // Crea il form per il nuovo messaggio
                      const formContent = `
                      <div class="space-y-4">
                        <h2 class="text-xl font-bold">Invia Messaggio WhatsApp</h2>
                        <div class="space-y-2">
                          <label class="text-sm font-medium">Numero di Telefono</label>
                          <input id="whatsapp-phone" type="text" class="w-full p-2 border rounded-md" value="${patient.phone}" />
                        </div>
                        <div class="space-y-2">
                          <label class="text-sm font-medium">Messaggio</label>
                          <textarea id="whatsapp-message" class="w-full p-2 border rounded-md h-32" placeholder="Scrivi il messaggio da inviare"></textarea>
                        </div>
                        <div class="flex justify-end space-x-2 pt-4">
                          <button id="cancel-whatsapp" class="px-4 py-2 border border-gray-300 rounded-md">Annulla</button>
                          <button id="send-whatsapp" class="px-4 py-2 bg-green-600 text-white rounded-md">Invia Messaggio</button>
                        </div>
                      </div>
                    `;
                      ...
                      // Gestisci la chiusura del form
                      document
                        .getElementById("cancel-whatsapp")
                        ?.addEventListener("click", () => {
                          document.body.removeChild(dialog);
                        });
                      ...
                      document
                        ...
                        ?.addEventListener("click", async () => {
                          ...
                          if (!phone || !message) {
                            alert("Inserisci sia il numero che il messaggio");
                            return;
                          }
                          ...
                          try {
                            ...
                            // Crea un appuntamento fittizio per il messaggio
                            ...
                            console.error(
                              "Errore durante l'invio del messaggio WhatsApp:",
                              error,
                            );
                            alert(
                              `Si è verificato un errore: ${error.message || "Errore sconosciuto"}`,
              ...
              <div className="space-y-4">
                ...
                {communications.length === 0 && (
                  <div className="text-center py-8 text-muted-foreground">
                    Nessuna comunicazione disponibile per questo paziente.
                  </div>
                )}
              </div>
            </TabsContent>
          ...
          <Card className="mt-6">
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  <h4 className="text-sm font-medium mb-1">Storia Medica</h4>
                ...
                <div>
                  <h4 className="text-sm font-medium mb-1">Allergie</h4>
                  <p className="text-sm text-muted-foreground">
                    {patient.allergies || "Nessuna allergia registrata"}
                  </p>
                </div>
                <div>
                  <h4 className="text-sm font-medium mb-1">Farmaci</h4>
                  <p className="text-sm text-muted-foreground">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {patient.notes || "Nessuna nota disponibile"}
                  </p>
                </div>
              </div>
            </CardContent>
